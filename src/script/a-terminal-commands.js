    ...
    return async function() {
        ...
        this.read(`${user}@oldServer\'s password:`).then(async function(password) {
            ...
            if(password === "Th!s!sS3CurEP455W0Rd") {
                ...
                await c.echo('Remember, p='+p+' and g='+g+'! Just use your secret number u. Easy!', {typing: true, delay: 100 });

                c.echo("\n\n")
                await c.echo('While you did your number crunching, I was also doing a calculation. My value for b='+b+'! Keep it in mind, you\'ll need it!', {typing: true, delay: 100 });
